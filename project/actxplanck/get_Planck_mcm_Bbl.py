...
for f1, freq1 in enumerate(freqs):
    ...
    for count1, hm1 in enumerate(splits):
        ...
        bl1_t = nmt_tools.load_beam(d["beam_%s_%s_T" % (freq1,hm1)]) # Convenience function to read planck style fits beams or ACT style txt beams
        bl1_pol = nmt_tools.load_beam(d["beam_%s_%s_pol" % (freq1,hm1)])
